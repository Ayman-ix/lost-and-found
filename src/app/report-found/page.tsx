    ...
    return (
      <div className="mx-auto max-w-lg px-4 py-20 text-center">
        ...
        <div className="mt-6 flex justify-center gap-3">
          <Link
            href="/login"
            className="rounded-xl bg-[#D3632D] px-5 py-2.5 text-xs font-bold uppercase tracking-wider text-white hover:bg-[#BA4F1D] shadow-sm transition"
          >
            Sign In Now
          </Link>
          <Link
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="mb-8 flex items-center justify-between">
        ...
        <span className="rounded-full bg-emerald-50 border border-emerald-200 px-3.5 py-1 text-xs font-bold text-emerald-700 uppercase tracking-wider">
          Found Report
        </span>
      </div>
      ...
      {successInfo ? (
        <div className="rounded-2xl border border-emerald-200 bg-emerald-50/70 p-8 text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            ...
            <Link
              href="/my-items"
              className="rounded-xl border border-emerald-300 bg-white px-5 py-2.5 text-xs font-bold text-emerald-800 hover:bg-emerald-50"
            >
              Go to My Items
            </Link>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-2">
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-600 py-3.5 text-sm font-bold uppercase tracking-wider text-white shadow-md shadow-emerald-500/20 hover:bg-emerald-700 disabled:opacity-50 transition active:scale-[0.99]"
              >
                {submitting ? (
